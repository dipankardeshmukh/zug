...
Function ${UN}EnvVarUpdate
  ...
  ;;      it was too long as well- write message to say set it by hand 
   ...
   ${OrIf} $8 >= ${NSIS_MAX_STRLEN}
     SetErrors
     DetailPrint "Installer cannot modify System Environment PATH as it is too long. Please set it manually."
     MessageBox MB_OK "Installer cannot modify System Environment PATH as it is too long. Please set it manually."
     Pop $8
     Pop $7
     Pop $6
     Goto EnvVarUpdate_Restore_Vars
