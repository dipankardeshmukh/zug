...
public class TestCycle { 
	...
	public String test_execution_detail_id=null;
	...
	/// Insert or Update testcase reult into TestExecutionDetail table.
	 private synchronized void SaveTestExecutionDetailsTable(int testCycleTopologySetId, List<TestCaseResult> testCaseResultList) throws Exception
	 {
         ...
         for (int i = 0; i < testCaseResultList.size(); i++)
         {
           ...
           //Getting and Storing the testexecutiondetailid in Class Variable 
             if(testExecutionDetailsTable.getTestExecutionDetailsId()!=null)
             this.test_execution_detail_id=testExecutionDetailsTable.getTestExecutionDetailsId().toString();
             else
            	 this.test_execution_detail_id="No Id Found";
