	...
	ReportingException,Exception,Throwable {
		...
		try {
			...
			if(Controller.guiFlag){
				...
				Controller.gui.showRunningTestCase(this.testCaseID, false);
				Controller.gui.updateTestCaseStatus(this.testCaseID, true);
			}
			...
			if(Controller.guiFlag){
				...
				Controller.gui.showRunningTestCase(this.testCaseID, false);
				Controller.gui.updateTestCaseStatus(this.testCaseID,false);
			}
