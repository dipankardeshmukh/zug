...
sudo mv /usr/lib/automature/SPARK/zug.linux /usr/lib/automature/SPARK/zug
if [ ! -e /usr/lib/automature/SPARK/Spark.ini ]
 then
sudo mv /usr/lib/automature/SPARK/Spark.ini.Linux /usr/lib/automature/SPARK/Spark.ini
fi
