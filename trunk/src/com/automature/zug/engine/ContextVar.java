...
//              Log.Debug("getContextVar: Parent ID = " + parentPId);
              ...
              Statement stat = conn.createStatement();
              //Log.Debug("getContextVar: Firing Command = " + "Select value From " + _tableName + " Where ProcessId=" + Quotedstring( Integer.toString(parentPId) ) + " And " + "Name=" + Quotedstring(name) + "");
              String value = null;
              synchronized (justForLock) {
	...
	public static void alterContextVar(String name, String value) throws Exception{
		 ...
		 try
		 {
             ...
             // Log.Debug("alterContextVar: Connection Opened .");
              ...
              Statement stat = conn.createStatement();
              //Log.Debug("alterContextVar: Firing Command = " + "Update " + _tableName + " Set Value="  + Quotedstring(value) +" Where " + "ProcessId=" + Quotedstring(Integer.toString(parentPId)) + " And Name=" + Quotedstring(name) + "");
              synchronized (justForLock) {
