...
public class ExtensionInterpreterSupport {
	...
	private static String filename="Spark.ini";
	...
	public static Hashtable<String, String[]> ReadFileExtensionXML(String inifilename) throws Exception {
	...
	public HashMap<String, ArrayList<String>> readExternalJarFileArchitecture(String attributeValue) throws Exception {
		...
		locationList = org.apache.xpath.XPathAPI.selectNodeList(document,Spark.inprocess_packages_file_path);
		...
		if (locationList.getLength()<1){
			...
			locationList = org.apache.xpath.XPathAPI.selectNodeList(document,Spark.inprocess_jar_xml_tag_path);
		}
	...
	public HashMap<String, ArrayList<String>> readNativePackageArchitecture(String attributeValue) throws Exception {
		...
		NodeList locationList = org.apache.xpath.XPathAPI.selectNodeList(document,Spark.native_inprocess_xml_tag_path);
	...
	public HashMap<String,String> retriveAdapterParams() throws Exception{
		return reteriveXMLAttributeValuePair(Spark.ADAPTERPARAMSPATH, "name");
	}
	...
	public HashMap<String,String> reteriveXMLAttributeValuePair(String nodeName,String attributeName) throws Exception {
		...
		ExtensionInterpreterSupport jarinterpreter = new ExtensionInterpreterSupport();
		NodeList locationList = org.apache.xpath.XPathAPI.selectNodeList(document, nodeName);
		HashMap<String,String> adapterParams = new HashMap<String,String>();
		for (int i = 0; i < locationList.getLength(); i++) {
			Element pathElement = (Element) locationList.item(i);

			adapterParams.put(pathElement.getAttribute(attributeName), pathElement.getTextContent());           
